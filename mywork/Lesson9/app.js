...
//     }
// };
// console.log("số lượng người có tuổi trên 50 là: " + countAge);
...
//         count++;
//     } else if (user.is_married !== 0) {
//         many++;
//     }
// };
// console.log("Số lượng đã kết hôn là: " + count);
// console.log("Số lượng chưa kết hôn là: " + many);
...
//     owner: "Oliver",
//     items: [
//         { id: 1, name: "VinFast", category: "White", price: 100 },
//         { id: 2, name: "Porsche", category: "Blue", price: 250 },
//         { id: 3, name: "Mercedes", category: "Black", price: 300 },
//     ]
// }

// function updatedInfo() {
//     console.log("Nhập lại thông tin kho hàng:");
//     market.name = prompt("Tên kho hàng:");
//     market.address = prompt("Địa chỉ kho hàng:");
//     market.owner = prompt("Người sở hữu kho hàng:");
